                                    ...
                                    <div className="flex items-start justify-between gap-3">
                                        ...
                                        {!isPendingForm && !isPendingConfirm && (
                                            <button
                                                ...
                                                className="inline-flex shrink-0 items-center gap-2 rounded-xl border border-emerald-500/40 bg-emerald-500/15 px-3 py-2 text-xs font-semibold text-emerald-500 hover:bg-emerald-500/25 disabled:opacity-60"
                                            >
                                                {checkingId === match.id ||
                                                    linkingId === match.id ? (
                                        ...
                                        <div className="space-y-3 rounded-xl border border-emerald-500/30 bg-emerald-500/5 p-3">
                                            ...
                                            <div className="flex gap-2">
                                                <button
                                                    ...
                                                    className="inline-flex h-10 flex-1 items-center justify-center gap-2 rounded-xl bg-emerald-500 text-sm font-semibold text-white hover:bg-emerald-600 disabled:opacity-60"
                                                >
                                                    {linkingId === match.id && (
                                                        <Loader2 size={16} className="animate-spin" />
                                                    )}
