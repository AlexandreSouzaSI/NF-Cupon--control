...
export function SuppliersReportTab() {
        ...
        <div className="space-y-5">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                ...
                <div className="rounded-3xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-5">
                    ...
                    <p className="text-sm text-zinc-600 dark:text-zinc-400">Compras sem NF</p>
                ...
                <div className="rounded-3xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-5">
                    ...
                    <p className="text-sm text-zinc-600 dark:text-zinc-400">Aguardando aprovação</p>
            ...
            <section className="rounded-3xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-5">
                <div className="mb-5 flex items-center justify-between">
                    <h2 className="text-lg font-bold">Por fornecedor</h2>
                ...
                {loading ? (
                    ...
                    <p className="text-sm text-zinc-600 dark:text-zinc-400">
                        Nenhum fornecedor com compra registrada nessa loja ainda.
                    </p>
                ) : (
